...
using ProtEquity.Application.SubCategory.Commands.DeleteSubCategory;
using ProtEquity.Application.SubCategory.Commands.UpdateSubCategory;
using ProtEquity.Application.SubCategory.Queries.GetAllSubCategories;
using ProtEquity.Application.SubCategory.Queries.GetSubCategoryById;

namespace ProtEquity.Web.Endpoints;
